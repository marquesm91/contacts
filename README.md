...
The Contact List example provided by [React Nanodegree Course](https://br.udacity.com/course/react-nanodegree--nd019).

## Test yourself

* `git clone https://github.com/marquesm91/contacts`
* `npm install` or `yarn`
* `npm start` or `yarn start`

## Important!

Make sure to run the background server before doing tests on this application. To get this, you must:
...
Note: the application will be listening on port `3000` and the background server on `5001`.
